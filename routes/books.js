...
const { getallbooks, getsinglebookbyid, getallissuedbooks ,addnewbook, updatebookbyid, deletebookbyid } = require('../controllers/bookcontroller');
...
router.get('/issued/foruser',getallissuedbooks);
